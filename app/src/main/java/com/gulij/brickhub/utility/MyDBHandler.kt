...
class MyDBHandler(private val myContext: Context) : SQLiteOpenHelper(myContext, DB_NAME, null, 2) {
    ...
    private fun checkDataBase(): Boolean {
        ...
        try {
            ...
            Log.e("ERRORRRR", "DATABASE DO NOT EXIST")
        }
    ...
    private fun getIventoriesListQuery(query: String): MutableList<Inventory>{
        Log.i("DB", myDataBase?.path.toString());
